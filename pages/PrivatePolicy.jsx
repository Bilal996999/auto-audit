                ...
                <div className='container mx-auto relative z-10 px-2 sm:px-6 lg:px-8'>
                    <div className='flex justify-between items-start gap-16 relative flex-wrap md:flex-nowrap'>
                        <div className='lg:w-[70%] w-full'>
                            ...
                            <a className='lg:text-[20px] md:text-[18px] sm:text-[16px] text-[14px] text-blue-600' href='mailto:info@autoauditpro.com'>info@autoauditpro.com</a><br/>
                            <a className='lg:text-[20px] md:text-[18px] sm:text-[16px] text-[14px] text-blue-600' href='tel:+1 (469) 943-0106'>+1 (469) 943-0106</a>
                        </div>
