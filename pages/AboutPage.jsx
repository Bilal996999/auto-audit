        ...
        <>
            ...
            <section className='mb-24 relative'>
                <div className='container mx-auto relative z-10 px-2 sm:px-6 lg:px-8'>
                    <div className='flex justify-between items-start gap-16 relative lg:flex-nowrap flex-wrap'>
                        ...
                        <aside className='lg:w-[30%] w-full lg:sticky lg:top-3 static bottom-3'>
                            <FloatVinCard />
                        </aside>
                    </div>
                </div>
