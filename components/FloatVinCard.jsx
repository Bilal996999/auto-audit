...
const FloatVinCard = () => {
  ...
  return (
    <div className='p-11 bg-[#EEF8FC] rounded-2xl text-center sticky top-0'>
      <h3 className='font-medium md:text-[32px] sm:text-[28px] text-[24px] leading-[1.3em]'>
      ...
      <small className='block md:text-[18px] sm:text-[16px] text-[14px] text-[#999] mt-6'>No VIN yet? Get a prepaid Auto Audit PRO VINreport</small>
      </form>
    </div>
  )
}
